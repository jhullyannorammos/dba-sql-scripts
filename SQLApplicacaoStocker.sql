...
/* ================================================= */
select * from application.fornecedores as frnc
         join application.produtos as prod
         join application.modelos as modl
         join application.mercadorias as merc
         on modelos.fornecedor_id = fornecedores.codigo
         and produtos.modelo_id = modelos.codigo
...
select serialnumber, produto, fornecedor, modelo 
       from application.fornecedores 
       join application.produtos
       join application.modelos 
       join application.mercadorias
...
/* ================================================= */
select mercadorias.codigo, estocada, serialnumber, produto, fornecedor, modelo
       from application.fornecedores 
       join application.modelos 
       join application.produtos
       join application.mercadorias
...
select * from application.patrimonios where mercadoria_id is not null;
select * from application.patrimonios where mercadoria_id is null;
select * from application.licenses where patrimonio_id is null;


CALL procedimento(parâmetros);
DELIMITER $$
